...
{
    public class StatKilledCasuariidae : Leaderstat
    {
        private bool debug = false;
        public StatKilledCasuariidae(ICoreServerAPI api) : base(api)
        {
            Title = "Most Large Birds Killed";
            Init(GetKeyPrefix());
            Id = "MOST_CASUARIIDAE_KILLED";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!entity.Code.ToString().Contains("casuariidae", StringComparison.OrdinalIgnoreCase)) return;
