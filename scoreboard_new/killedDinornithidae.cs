...
{
    public class StatKilledDinornithidae : Leaderstat
    {
        private bool debug = false;
        public StatKilledDinornithidae(ICoreServerAPI api) : base(api)
        {
            Title = "Most Flightless Birds Killed";
            Init(GetKeyPrefix());
            Id = "MOST_DINORNITHIDAE_KILLED";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!entity.Code.ToString().Contains("dinornithidae", StringComparison.OrdinalIgnoreCase)) return;
