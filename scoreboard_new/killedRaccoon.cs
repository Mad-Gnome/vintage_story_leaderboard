...
{
    public class StatKilledRaccoon : Leaderstat
    {
        private bool debug = false;
        public StatKilledRaccoon(ICoreServerAPI api) : base(api)
        {
            Title = "Most Raccoons Killed";
            Init(GetKeyPrefix());
            Id = "MOST_RACCOON_KILLED";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!entity.Code.ToString().Contains("raccoon", StringComparison.OrdinalIgnoreCase)) return;
