...
{
    public class StatKilledByDrifter: Leaderstat
    {
        private bool debug = false;
        
        public StatKilledByDrifter(ICoreServerAPI api) : base(api)
        {
            Title = "Died to Drifters";
            Init(GetKeyPrefix());
            Id = "MOST_KILLED_BY_DRIFTER";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!killer.Contains("drifter")) return;
