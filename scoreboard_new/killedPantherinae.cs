...
{
    public class StatKilledPantherinae : Leaderstat
    {
        private bool debug = false;
        public StatKilledPantherinae(ICoreServerAPI api) : base(api)
        {
            Title = "Most Large Cats Killed";
            Init(GetKeyPrefix());
            Id = "MOST_PANTHERINAE_KILLED";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!entity.Code.ToString().Contains("pantherinae", StringComparison.OrdinalIgnoreCase)) return;
