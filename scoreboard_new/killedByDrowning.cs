...
{
    public class StatKilledByDrowning: Leaderstat
    {
        private bool debug = false;
        public StatKilledByDrowning(ICoreServerAPI api) : base(api)
        {
            Title = "Died by Drowning";
            Init(GetKeyPrefix());
            Id = "KILLED_BY_DROWNING";
        ...
        public override void OverrideCB(IServerPlayer byPlayer, DamageSource damageSource)
        {
            ...
            if (damageSource == null || damageSource.Type.ToString() != "Suffocation") return;
