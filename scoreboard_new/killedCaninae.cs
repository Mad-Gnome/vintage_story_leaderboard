...
{
    public class StatKilledCaninae : Leaderstat
    {
        private bool debug = false;
        public StatKilledCaninae(ICoreServerAPI api) : base(api)
        {
            Title = "Most Canines Killed";
            Init(GetKeyPrefix());
            Id = "MOST_CANINAE_KILLED";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!entity.Code.ToString().Contains("caninae", StringComparison.OrdinalIgnoreCase)) return;
