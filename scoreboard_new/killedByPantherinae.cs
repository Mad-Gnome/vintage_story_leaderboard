...
{
    public class StatKilledByPantherinae: Leaderstat
    {
        private bool debug = false;
        
        public StatKilledByPantherinae(ICoreServerAPI api) : base(api)
        {
            Title = "Died to Big Cats";
            Init(GetKeyPrefix());
            Id = "MOST_KILLED_BY_PANTHERINAE";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!killer.Contains("pantherinae")) return;
