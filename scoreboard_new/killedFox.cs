...
{
    public class StatKilledFox : Leaderstat
    {
        private bool debug = false;
        public StatKilledFox(ICoreServerAPI api) : base(api)
        {
            Title = "Most Foxes Killed";
            Init(GetKeyPrefix());
            Id = "MOST_FOX_KILLED";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!entity.Code.ToString().Contains("fox", StringComparison.OrdinalIgnoreCase)) return;
