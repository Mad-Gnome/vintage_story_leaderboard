...
{
    public class StatKilledPig : Leaderstat
    {
        private bool debug = false;
        public StatKilledPig (ICoreServerAPI api) : base(api)
        {
            Title = "Most Pigs Killed";
            Init(GetKeyPrefix());
            Id = "MOST_PIG_KILLED";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!entity.Code.ToString().Contains("pig", StringComparison.OrdinalIgnoreCase)) return;
