...
{
    public class StatKilledDrifter : Leaderstat
    {
        private bool debug = false;
        public StatKilledDrifter(ICoreServerAPI api) : base(api)
        {
            Title = "Most Drifters Killed";
            Init(GetKeyPrefix());
            Id = "MOST_DRIFTER_KILLED";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!entity.Code.ToString().Contains("drifter", StringComparison.OrdinalIgnoreCase)) return;
