...
{
    public class StatKilledByDinornithidae : Leaderstat
    {
        private bool debug = false;
        
        public StatKilledByDinornithidae(ICoreServerAPI api) : base(api)
        {
            Title = "Died to Flightless Birds";
            Init(GetKeyPrefix());
            Id = "MOST_KILLED_BY_DINORNITHIDAE";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!killer.Contains("dinornithidae")) return;
