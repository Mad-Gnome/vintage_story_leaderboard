...
{
    public class StatKilledRabbit : Leaderstat
    {
        private bool debug = false;
        public StatKilledRabbit(ICoreServerAPI api) : base(api)
        {
            Title = "Most Rabbits Killed";
            Init(GetKeyPrefix());
            Id = "MOST_RABBIT_KILLED";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!entity.Code.ToString().Contains("hare", StringComparison.OrdinalIgnoreCase)) return;
