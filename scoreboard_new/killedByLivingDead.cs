...
{
    public class StatKilledByLivingDead : Leaderstat
    {
        private bool debug = false;
        
        public StatKilledByLivingDead(ICoreServerAPI api) : base(api)
        {
            Title = "Died to Living Dead";
            Init(GetKeyPrefix());
            Id = "MOST_KILLED_BY_LIVINGDEAD";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!killer.Contains("livingdead")) return;
