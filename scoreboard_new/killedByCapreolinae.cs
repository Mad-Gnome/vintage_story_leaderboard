...
{
    public class StatKilledByCapreolinae: Leaderstat
    {
        private bool debug = false;
        
        public StatKilledByCapreolinae(ICoreServerAPI api) : base(api)
        {
            Title = "Died to Deer";
            Init(GetKeyPrefix());
            Id = "MOST_KILLED_BY_CAPREOLINAE";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!killer.Contains("capreolinae")) return;
