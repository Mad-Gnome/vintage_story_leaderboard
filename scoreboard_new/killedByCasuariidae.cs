...
{
    public class StatKilledByCasuariidae: Leaderstat
    {
        private bool debug = false;
        
        public StatKilledByCasuariidae(ICoreServerAPI api) : base(api)
        {
            Title = "Died to Large Birds";
            Init(GetKeyPrefix());
            Id = "MOST_KILLED_BY_CASUARIIDAE";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!killer.Contains("casuariidae")) return;
