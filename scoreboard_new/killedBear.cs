...
{
    public class StatKilledBear : Leaderstat
    {
        private bool debug = false;
        public StatKilledBear(ICoreServerAPI api) : base(api)
        {
            Title = "Most Bears Killed";
            Init(GetKeyPrefix());
            Id = "MOST_BEAR_KILLED";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!entity.Code.ToString().Contains("bear", StringComparison.OrdinalIgnoreCase)) return;
