...
{
    public class StatKilledMachairodontinae : Leaderstat
    {
        private bool debug = false;
        public StatKilledMachairodontinae(ICoreServerAPI api) : base(api)
        {
            Title = "Most Saber Cats Killed";
            Init(GetKeyPrefix());
            Id = "MOST_MACHAIRODONTINAE_KILLED";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!entity.Code.ToString().Contains("machairodontinae", StringComparison.OrdinalIgnoreCase)) return;
