...
{
    public class StatKilledByRhinocerotidae: Leaderstat
    {
        private bool debug = false;
        
        public StatKilledByRhinocerotidae(ICoreServerAPI api) : base(api)
        {
            Title = "Died to Rhinos";
            Init(GetKeyPrefix());
            Id = "MOST_KILLED_BY_RHINOCEROTIDAE";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!killer.Contains("rhinocerotidae")) return;
