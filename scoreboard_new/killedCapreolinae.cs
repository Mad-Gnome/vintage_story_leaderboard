...
{
    public class StatKilledCapreolinae : Leaderstat
    {
        private bool debug = false;
        public StatKilledCapreolinae(ICoreServerAPI api) : base(api)
        {
            Title = "Most Deer Killed";
            Init(GetKeyPrefix());
            Id = "MOST_CAPREOLINAE_KILLED";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!entity.Code.ToString().Contains("capreolinae", StringComparison.OrdinalIgnoreCase)) return;
