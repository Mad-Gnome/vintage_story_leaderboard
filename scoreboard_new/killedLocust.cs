...
{
    public class StatKilledLocust : Leaderstat
    {
        private bool debug = false;
        public StatKilledLocust(ICoreServerAPI api) : base(api)
        {
            Title = "Most Locusts Killed";
            Init(GetKeyPrefix());
            Id = "MOST_LOCUST_KILLED";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!entity.Code.ToString().Contains("locust", StringComparison.OrdinalIgnoreCase)) return;
