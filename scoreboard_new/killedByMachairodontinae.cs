...
{
    public class StatKilledByMachairodontinae: Leaderstat
    {
        private bool debug = false;
        
        public StatKilledByMachairodontinae(ICoreServerAPI api) : base(api)
        {
            Title = "Died to Saber Cats";
            Init(GetKeyPrefix());
            Id = "MOST_KILLED_BY_MACHAIRODONTINAE";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!killer.Contains("machairodontinae")) return;
