...
{
    public class StatKilledByManidae: Leaderstat
    {
        private bool debug = false;
        
        public StatKilledByManidae(ICoreServerAPI api) : base(api)
        {
            Title = "Died to Pangolins";
            Init(GetKeyPrefix());
            Id = "MOST_KILLED_BY_MANIDAE";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!killer.Contains("manidae")) return;
