...
{
    public class StatKilledGoat : Leaderstat
    {
        private bool debug = false;
        public StatKilledGoat(ICoreServerAPI api) : base(api)
        {
            Title = "Most Goats Killed";
            Init(GetKeyPrefix());
            Id = "MOST_GOAT_KILLED";
        ...
        public override void OverrideCB(Entity entity, DamageSource damageSource)
        {
            ...
            if (!entity.Code.ToString().Contains("goat", StringComparison.OrdinalIgnoreCase)) return;
